...
### Lấy (access) dữ liệu options

```php
// Lấy toàn bộ theme options
$options = get_option('theme_options', []);

// Lấy một option cụ thể bằng dot notation
...
$tagline = mytheme_option('general.identity.site_tagline', 'Tagline mặc định');
```
...
* **Field Types** (/fields) — Khám phá các loại field có sẵn
* **Stores** (/stores) — Tìm hiểu về Options, Post Meta, Term Meta và User Meta
* **Advanced Usage** (/advanced) — Logic điều kiện, validation và nhiều hơn nữa
